...
import { BottomNav, JedagBadge, JedagButton, JedagCard, CardBody, JedagChip, StepDots, SearchInput } from '@/components/jedag';
import { Bell, QrCode, ChevronRight, Clock, MapPin, Truck, Shield, Video } from 'lucide-react';
            ...
            <section className="px-5 -mt-3 mb-6">
                <div className="bg-white rounded-2xl shadow-md p-4">
                    <div className="grid grid-cols-4 gap-2">
                        <Link
                            href="/scan"
                            className="flex flex-col items-center gap-2 p-3 rounded-xl hover:bg-ink-50 transition-colors press-feedback"
                        >
                    ...
                    <div className="flex gap-3" style={{ width: 'max-content' }}>
                        {[
                            ...
                            <div key={i} className="w-64 bg-white rounded-xl shadow-sm p-4 shrink-0">
                                <JedagChip variant="leaf" className="mb-2 text-xs h-6">
                                    {tip.category}
                                </JedagChip>
        ...
        <Link href={`/jejak/${qurban.id}`}>
            <JedagCard className="overflow-hidden press-feedback">
                ...
                <div className="relative h-48">
                    <Image src={qurban.image} alt={qurban.name} fill className="object-cover" />
                    ...
                    <div className="absolute top-3 left-3 flex gap-2">
                        {qurban.liveTracking && <JedagBadge variant="live">LIVE</JedagBadge>}
                    ...
                    <div className="absolute bottom-3 left-3 right-3 text-white">
                        ...
                        <p className="text-sm text-white/80">
                            {qurban.species} &middot; {qurban.weight} kg
                        </p>
                    </div>
                </div>
